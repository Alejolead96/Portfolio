...
const Layout = () => {
  return (
    <div className="lg:w-90 sticky top-8 h-fit bg-sky-100/10 border-gray-300 border dark:bg-secondary-dark dark:border-primary-border-dark rounded-md p-6">
      <div className="flex flex-col items-center gap-4 border-b border-gray-300 dark:border-b-primary-border-dark py-6">
        <img src="/me.png" alt="" className="w-30 h-30 rounded-md" />
